...
function CreateUserRole() {
    ...
    const handleFormSubmit = (event) => {
        ...
        API.post(endpoints['create-user-role'], json, {
            ...
            if (res.status === STATUS_200_OK) {
                ...
                alert(t("user-role.message-create-user-success"))
                nav(-1)
            } else {

                alert(t("user-role.message-create-user-failed"))
                nav(-1)
            }
        })
    }
    ...
    return (
        <>
            ...
            <h2 className='text-center mt-8 text-2xl uppercase font-bold'>{t("user-role.create-user")}</h2>
