...
function FormatJournalEditor() {
    ...
    const handleSubmitClick = () => {
        ...
        API.post(endpoints['submit-format-journal-publish'](journalId), json, {
            headers: {
                ...
                <div className='w-full relative m-auto min-h-screen text-base'>
                    ...
                    <div className='h-full overflow-scroll'>
                        ...
                        <div className='ml-[251px]'>
                            {/* wrapper content */}
                            <div className='mx-8 my-4 min-h-[1000px]'>
...
export default FormatJournalEditor